...
VALUES (DEFAULT,MINE_GUID,MINE_LAT,MINE_LONG,DEFAULT,DEFAULT,IDIR_USER,DEFAULT,IDIR_USER,DEFAULT);
...
INSERT INTO permit
VALUES
    (PERMIT_GUID1,MINE_GUID,PERMIT_NO1,DEFAULT,ISSUE_DATE1,'C',IDIR_USER,DEFAULT,IDIR_USER,DEFAULT,DEFAULT),
    (PERMIT_GUID2,MINE_GUID,PERMIT_NO2,DEFAULT,ISSUE_DATE2,'O',IDIR_USER,DEFAULT,IDIR_USER,DEFAULT,DEFAULT);
