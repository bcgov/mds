...
WITH a AS (
    ...
    VALUES ('9C1B63B6-CCFB-48B0-BE85-3CB3C5D1A276','DummyUser',now(),'DummyUser',now()+interval '23 days')
    RETURNING mine_guid
)
...
VALUES (DEFAULT,(SELECT mine_guid FROM a),'BLAH0000','VIVIANTEST',now(),'9999-09-09','DummyUser',now(),'DummyUser',now()+interval '23 days');
WITH b AS(
...
VALUES (DEFAULT,(SELECT mine_guid FROM b),'48','-125',now(),'9999-09-09','DummyUser',now(),'DummyUser',now()+interval '23 days');
