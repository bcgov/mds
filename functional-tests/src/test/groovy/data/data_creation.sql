...
VALUES (DEFAULT,MINE_GUID,MINE_NO,MINE_NAME,MINE_NOTE,EFFECTIVE_DATE,DEFAULT,IDIR_USER,DEFAULT,IDIR_USER,DEFAULT);
...
VALUES 
    (DEFAULT,PERMIT_GUID1,PARTY_GUID1,IDIR_USER,DEFAULT,IDIR_USER,DEFAULT,EFFECTIVE_DATE,DEFAULT),
    (DEFAULT,PERMIT_GUID2,PARTY_GUID2,IDIR_USER,DEFAULT,IDIR_USER,DEFAULT,EFFECTIVE_DATE,DEFAULT);
