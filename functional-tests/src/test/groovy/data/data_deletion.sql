...
BEGIN
    ...
    -- DELETE FROM mine_expected_document WHERE create_user LIKE IDIR_USER ON DELETE CASCADE;
    TRUNCATE TABLE mine CASCADE;
    TRUNCATE TABLE mine_expected_document CASCADE;--HERE create_user LIKE IDIR_USER;
