...
export const FETCH_MINE_REPORT_COMMENTS = "FETCH_MINE_REPORT_COMMENTS";
export const SUBMIT_MINE_REPORT_COMMENT = "SUBMIT_MINE_REPORT_COMMENTS";
export const MINE_REPORT_COMMENT_CREATED = "MINE_REPORT_COMMENT_CREATED";
