...
// notice of work
export const STORE_NOTICE_OF_WORK_SUBMISSIONS = "STORE_NOTICE_OF_WORK_SUBMISSIONS";
export const STORE_NOTICE_OF_WORK_SUBMISSION = "STORE_NOTICE_OF_WORK_SUBMISSION";
