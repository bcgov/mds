...
export const ADD_INCIDENT_REPORTING = "ADD_INCIDENT_REPORTING";
export const ADD_INCIDENT_DETAIL = "ADD_INCIDENT_DETAIL";
export const ADD_INCIDENT_FOLLOWUP = "ADD_INCIDENT_FOLLOWUP";
