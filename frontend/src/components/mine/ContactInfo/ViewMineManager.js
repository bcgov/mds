            ...
            <Card>
                ...
                <tbody>
                  ...
                  <tr>
                    <td data-label="Mine Manager">
                      <Link
                        to={router.PARTY_PROFILE.dynamicRoute(mine.mgr_appointment[0].party_guid)}
                      >
                        <p className="p-large">{mine.mgr_appointment[0].name}</p>
                      </Link>
                    </td>
                    <td data-label="Manager Since">
                      <p className="p-large">{mine.mgr_appointment[0].effective_date}</p>
                    </td>
                  </tr>
                  <tr>
                    <th scope="col">
                  ...
                  <tr>
                    <td data-label="Email">
                      <p className="p-large">{mine.mgr_appointment[0].email}</p>
                    </td>
              ...
              {this.state.isHistoryVisible && (
                <div className="table-wrapper">
                  ...
                  {mine.mgr_appointment.length <= 1 && <NullScreen type="view-mine-manager" />}
                </div>
              )}
            </Card>
          </div>
