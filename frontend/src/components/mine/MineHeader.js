...
class MineHeader extends Component {
  ...
  renderInitialValues = (mine) => {
    ...
    const initialValues = {
      "name": mine.mine_detail[0].mine_name ? mine.mine_detail[0].mine_name : null,
      "latitude": mine.mine_location[0].latitude ? mine.mine_location[0].latitude : null,
      "longitude": mine.mine_location[0].longitude ? mine.mine_location[0].longitude : null,
    }
    return (
