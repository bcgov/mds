...
export const createItemMap = (array, idField) => array.reduce((result, item) => {
...
export const createDropDownList = (array, labelField, valueField) => array.map((item) => ({ value: item[valueField], label: item[labelField] }));
