...
export enum NetworkReducerTypes {
    ...
    GET_PERMIT_CONDITION_TAGS = "GET_PERMIT_CONDITION_TAGS",
    UPDATE_PERMIT_CONDITION_TAG = "UPDATE_PERMIT_CONDITION_TAG",
    CREATE_PERMIT_CONDITION_TAG = "CREATE_PERMIT_CONDITION_TAG",
    DELETE_PERMIT_CONDITION_TAG = "DELETE_PERMIT_CONDITION_TAG",
