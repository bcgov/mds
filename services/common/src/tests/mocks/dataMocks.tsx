...
export const STANDARD_PERMIT_CONDITIONS: IStandardPermitCondition[] = [
  {
    ...
    condition: "Approval - This permit authorizes only the following mining activities as outlined in the Mine Plan and Reclamation Program. Mining activities conducted that are not listed below are considered to be undertaken without a permit as required by Mines Act 10(1):",
    ...
    sub_conditions: [
        ...
        sub_conditions: [
          {
            ...
            condition: "Work Related Structures: Core tent, office, dry tent, first aid etc. [xx.x ha]",
            condition_category_code: "GEC",
          ...
          },
          {
            ...
            condition: "Exploration Access Construction/Modification: description, dimensions, etc [xx.x ha]",
            condition_category_code: "GEC",
            parent_standard_permit_condition_id: 420,
            parent_permit_condition_id: 420,
            condition_type_code: "LIS",
      ...
      },
      {
        ...
        condition: "Approved activities must be conducted as outlined in Document 1.1, Description of Work Program. \nOR Activities must be conducted as outlined in [Document X]. ",
        condition_category_code: "GEC",
        parent_standard_permit_condition_id: 400,
        parent_permit_condition_id: 400,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Authorized activities are restricted to the period from [seasonal date interval] [unless xyz occurs]",
        condition_category_code: "GEC",
        parent_standard_permit_condition_id: 400,
        parent_permit_condition_id: 400,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "The use of all-terrain vehicles (ATVs) and utility task vehicles (UTVs) is [not authorized/restricted to business purposes/restricted to authorized exploration access].",
        condition_category_code: "GEC",
        parent_standard_permit_condition_id: 400,
        parent_permit_condition_id: 400,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "The construction of new access is limited to spur roads of no more than [50m/100m/200m, etc.] in length from the existing access as shown on the attached mapping. [Figure X, Figure Y and Figure Z.]",
        condition_category_code: "GEC",
        parent_standard_permit_condition_id: 400,
        parent_permit_condition_id: 400,
        condition_type_code: "CON",
    ...
    sub_conditions: [
      {
        ...
        condition: "The MERP required under 3.7.1 of the Code must be maintained on the mine site and made available to an inspector upon request.",
        condition_category_code: "HSC",
    ...
    sub_conditions: [
      {
        ...
        condition: "[X dollars] $<<bond_amt>> in security must be maintained with the Minister of Finance.",
        condition_category_code: "RCC",
      ...
      },
      {
        ...
        condition: "The security must be deposited in accordance with the following installment schedule:",
        condition_category_code: "RCC",
        parent_standard_permit_condition_id: 415,
        parent_permit_condition_id: 415,
        condition_type_code: "CON",
        sub_conditions: [
          {
            ...
            condition: "Prior to the mobilization of heavy equipment to the site for the purposes of construction of <<description of activity>>: <<$Dollar amount>> for a subtotal of <<$Dollar Amount>>; and",
            condition_category_code: "RCC",
          ...
          },
          {
            ...
            condition: "Within [Enter time] months following the start of construction of <<description of activity>>: <<$Dollar Amount>> for a total of <<$Dollar Amoun>>.",
            condition_category_code: "RCC",
            parent_standard_permit_condition_id: 541,
            parent_permit_condition_id: 541,
            condition_type_code: "LIS",
    ...
    sub_conditions: [
      {
        ...
        condition: "The Chief Inspector must be advised in writing upon discovery of any unforeseen conditions that could adversely affect the extraction of materials, site stability, erosion control or the reclamation of the site.",
        condition_category_code: "GOC",
      ...
      },
      {
        ...
        condition: "An Advice of Geotechnical Incident form must be submitted to the Chief Inspector for any geotechnical incident that:",
        condition_category_code: "GOC",
        parent_standard_permit_condition_id: 406,
        parent_permit_condition_id: 406,
        condition_type_code: "CON",
        sub_conditions: [
          ...
          },
          {
            ...
            condition: "requires changes to an existing standard operating procedure or the creation of a site-specific safe work plan.",
            condition_category_code: "GOC",
            parent_standard_permit_condition_id: 453,
            parent_permit_condition_id: 453,
            condition_type_code: "LIS",
    ...
    sub_conditions: [
      {
        ...
        condition: "The Archaeological Chance Find Procedure (CFP) (Document  1.4  –  update  as  required) must be implemented prior to commencement of work. All employees and contractors at the mine site must be trained on the CFP. [The plan must be maintained onsite and available to an Inspector upon request.] ",
        condition_category_code: "ELC",
      ...
      },
      {
        ...
        condition: "In addition to [Document XX] –   update as required), [First Nation’s Name]’s CFP must be implemented prior to commencement of work. All employees and contractors at the mine site must be trained on the [First Nation’s Name]’s CFP.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 410,
        parent_permit_condition_id: 410,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "The  recommendations  provided  in  the  document:  [Name  of  Archeological  Study  document, Date (Author of document)] must be implemented.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 410,
        parent_permit_condition_id: 410,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Prior  to  any  ground  disturbance,  evaluation  for  archaeological  potential  in  the  area  of  work must be conducted by a qualified professional. Any recommendations provided by a qualified professional resulting from this evaluation must be implemented.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 410,
        parent_permit_condition_id: 410,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Prior  to  any  mechanical  ground  disturbance  [in  high  archaeological  potential  and  not  previously disturbed], an archaeological assessment must be conducted by a qualified professional.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 410,
        parent_permit_condition_id: 410,
        condition_type_code: "CON",
        sub_conditions: [
          {
            ...
            condition: "Any recommendations provided by the qualified professional resulting from this evaluation must be implemented.",
            condition_category_code: "ELC",
    ...
    sub_conditions: [
      {
        ...
        condition: "Garbage and other animal attractants must be removed from work sites daily or stored in a secure and airtight container until removed from the mine site.",
        condition_category_code: "ELC",
      ...
      },
      {
        ...
        condition: "Water intakes must comply with the Freshwater Intake End-of-Pipe Fish Screen Guideline, 1995 (Department of Fisheries and Oceans), or most recent version thereof.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 411,
        parent_permit_condition_id: 411,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Erosion and sediment must be effectively controlled on the mine site. Sediment laden water must be suitably contained on the mine site and not be allowed access to any watercourse.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 411,
        parent_permit_condition_id: 411,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "All flight paths must be recorded using a spatial recording system and the raw data must be available upon request to an inspector at the end of each field season.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 411,
        parent_permit_condition_id: 411,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "For any discharge of sediment laden water originating from the mine site, immediate measures must be taken to prevent further and future discharges.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 411,
        parent_permit_condition_id: 411,
        condition_type_code: "CON",
        sub_conditions: [
          {
            ...
            condition: "Discharge that reaches a surface water body must be documented with estimates on flow rate and photographs and reported to the Chief Inspector at [Regional Mines e-mail Inbox] within 24 hours of discovery. <<OR>> for advanced exploration:",
            condition_category_code: "ELC",
      ...
      },
      {
        ...
        condition: "Any significant releases of sediment-laden water, defined as an unauthorized discharge to the receiving environment, must be appropriately characterized with respect to extent and loading, and reported to the Chief Inspector at [Regional Mines Office e-mail Inbox] within [28 days] of discovery.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 411,
        parent_permit_condition_id: 411,
        condition_type_code: "CON",
        sub_conditions: [
          {
            ...
            condition: "Characterization of unauthorized discharges of sediment-laden run-off must include, at a minimum, flow, total suspended solids, turbidity, pH, conductivity, temperature, dissolved oxygen, and total and dissolved metals, of both the effluent and the receiving water.",
            condition_category_code: "ELC",
    ...
    sub_conditions: [
      {
        ...
        condition: "Reclamation of the surface of the land affected by the operations must be conducted in accordance with the approved work program. The surface of the land and watercourses must be reclaimed to the following end land use: <<land_use>>;",
        condition_category_code: "RCC",
      ...
      },
      {
        ...
        condition: "Reclamation obligations include [xxx disturbance(s)], but exclude [xxx disturbance(s)].",
        condition_category_code: "RCC",
        parent_standard_permit_condition_id: 416,
        parent_permit_condition_id: 416,
        condition_type_code: "CON",
    ...
    sub_conditions: [
      {
        ...
        condition: "Handling, transportation and storage of fuels and lubricants must conform to the requirements of the document:  BC Fuel Guidelines, 13th Edition, February 27, 2024 (NorthWest Response Ltd), or most recent version thereof.",
        condition_category_code: "HSC",
    ...
    sub_conditions: [
      {
        ...
        condition: "Stockpiles of waste, overburden or soil must not be placed in areas identified as Terrain Class IV or V.",
        condition_category_code: "GOC",
    ...
    sub_conditions: [
      {
        ...
        condition: "Unless otherwise specified, the definitions in the Mines Act, the regulations and the Code apply to the use of the terms in this permit.",
        condition_category_code: "GEC",
    ...
    sub_conditions: [
      {
        ...
        condition: "Prior to initiating road or trail construction, a qualified person must determine the terrain stability classification for all areas where roads and trails are to be constructed.",
        condition_category_code: "GOC",
    ...
    sub_conditions: [
      {
        ...
        condition: "Invasive plants on the site must be identified, monitored, controlled and documented. Monitoring and treatment records must be made available to an Inspector upon request.",
        condition_category_code: "ELC",
      ...
      },
      {
        ...
        condition: "Reasonable efforts must be taken to ensure that invasive plants do not migrate from the site to adjacent areas.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 412,
        parent_permit_condition_id: 412,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "The control of invasive plants must consider using non-toxic means for invasive plant control.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 412,
        parent_permit_condition_id: 412,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "[At least 90 days] prior to the commencement of work under this Permit, an Invasive Plants Management Plan must be developed to the satisfaction of the Chief Permitting Officer and the plan must be implemented in doing any work under this Permit.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 412,
        parent_permit_condition_id: 412,
        condition_type_code: "CON",
    ...
    sub_conditions: [
      {
        ...
        condition: "All documents referenced in the permit must be kept at the mine and must be available to an inspector upon request.",
        condition_category_code: "GEC",
      ...
      },
      {
        ...
        condition: "A completed Annual Summary of Exploration Activities (ASEA) form must be submitted via MineSpace prior to March 31 annually and must be accompanied by:",
        condition_category_code: "GEC",
        parent_standard_permit_condition_id: 401,
        parent_permit_condition_id: 401,
        condition_type_code: "CON",
        sub_conditions: [
          ...
          },
          {
            ...
            condition: "spatial  data  of  the  as-built disturbances  which  includes  attribution  data  for  the  status of reclamation.",
            condition_category_code: "GEC",
            parent_standard_permit_condition_id: 437,
            parent_permit_condition_id: 437,
            condition_type_code: "LIS",
      ...
      },
      {
        ...
        condition: "For Multi-Year Area-Based (MYAB) work programs, a MYAB annual update form must be submitted annually via MineSpace.  The MYAB update must be submitted at least two (2) weeks prior to the anticipated commencement of exploration activities in a new calendar year, or no later than March 31 for every year the MYAB approval is in effect.  In addition to the required mapping, the Permittee must submit spatial files of current and proposed disturbances.",
        condition_category_code: "GEC",
        parent_standard_permit_condition_id: 401,
        parent_permit_condition_id: 401,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Work in subsequent years from the approval date for MYAB work programs must not commence without written approval from the Chief Permitting Officer based on the review of the annual update and receipt of any additional reclamation security as required by the Chief Permitting Officer.",
        condition_category_code: "GEC",
        parent_standard_permit_condition_id: 401,
        parent_permit_condition_id: 401,
        condition_type_code: "CON",
    ...
    sub_conditions: [
      {
        ...
        condition: "All available topsoil, overburden, and organic material including large woody debris in the disturbance footprint must be salvaged and stockpiled for use in reclamation.",
        condition_category_code: "RCC",
      ...
      },
      {
        ...
        condition: "All stockpiled topsoil, overburden, and organic material including large woody debris must: ",
        condition_category_code: "RCC",
        parent_standard_permit_condition_id: 417,
        parent_permit_condition_id: 417,
        condition_type_code: "CON",
        sub_conditions: [
          ...
          },
          {
            ...
            condition: "be clearly marked to ensure that they are protected during construction and mine operations, ",
            condition_category_code: "RCC",
            parent_standard_permit_condition_id: 547,
            parent_permit_condition_id: 547,
            condition_type_code: "LIS",
          ...
          },
          {
            ...
            condition: "not be removed from the mine site without the specific written permission of an Inspector.",
            condition_category_code: "RCC",
            parent_standard_permit_condition_id: 547,
            parent_permit_condition_id: 547,
            condition_type_code: "LIS",
        ...
        sub_conditions: [
          {
            ...
            condition: "Compacted surfaces must be de-compacted to allow water infiltration and achieve self-sustaining vegetation.",
            condition_category_code: "RCC",
          ...
          },
          {
            ...
            sub_conditions: [
              ...
              },
              {
                ...
                condition: "be keyed into the underlying materials such that they do not slump off or become unstable;",
                condition_category_code: "RCC",
                parent_standard_permit_condition_id: 553,
                parent_permit_condition_id: 553,
                condition_type_code: "LIS",
              ...
              },
              {
                ...
                condition: "incorporate roots, stumps and other woody debris to reduce erosion and create greater biological diversity; and",
                condition_category_code: "RCC",
                parent_standard_permit_condition_id: 553,
                parent_permit_condition_id: 553,
                condition_type_code: "LIS",
              ...
              },
              {
                ...
                condition: "be re-vegetated promptly to a self-sustaining state using appropriate and/or native plant species that support approved end land use.",
                condition_category_code: "RCC",
                parent_standard_permit_condition_id: 553,
                parent_permit_condition_id: 553,
                condition_type_code: "LIS",
      ...
      },
      {
        ...
        condition: "Disturbances that have been determined to be necessary for future use beyond [X Date] must:",
        condition_category_code: "RCC",
        parent_standard_permit_condition_id: 417,
        parent_permit_condition_id: 417,
        condition_type_code: "CON",
        sub_conditions: [
          ...
          },
          {
            ...
            condition: "have  a  care  and  maintenance  plan  submitted  to  [Regional  Office  e-mail]  and approved by the Chief Permitting Officer. ",
            condition_category_code: "RCC",
            parent_standard_permit_condition_id: 909,
            parent_permit_condition_id: 909,
            condition_type_code: "LIS",
    ...
    sub_conditions: [
      {
        ...
        condition: "The Manager must provide written notification, fourteen days prior to a blast notify the Senior Health & Safety Inspector for the [Region] at [Regional Mines Office email].",
        condition_category_code: "HSC",
      ...
      },
      {
        ...
        condition: "Blasting is not authorized to occur between [Date Range or Time Range or  Other Schedule].",
        condition_category_code: "HSC",
        parent_standard_permit_condition_id: 564,
        parent_permit_condition_id: 564,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "All blasts must occur between [Monday to Friday between 10am and 5pm], blasting must not occur on Statutory Holidays;",
        condition_category_code: "HSC",
        parent_standard_permit_condition_id: 564,
        parent_permit_condition_id: 564,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Controlled blasting methods (e.g. trim and buffer, pre/post shear) must be implemented to minimize damage to the crest and bench face of all final walls and on any interim walls that will be in place for a period exceeding 12 months.",
        condition_category_code: "HSC",
        parent_standard_permit_condition_id: 564,
        parent_permit_condition_id: 564,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Controlled blasting may be omitted where a Professional Engineer assesses conditions and states in writing that worker safety will not be adversely endangered by the proposed excavation.",
        condition_category_code: "HSC",
        parent_standard_permit_condition_id: 564,
        parent_permit_condition_id: 564,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Blast limits are established at 50 millimeters per second peak particle velocity and 120 decibels on the L scale, at the permit area boundary.",
        condition_category_code: "HSC",
        parent_standard_permit_condition_id: 564,
        parent_permit_condition_id: 564,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "The electronic monitor unit must be located such that the air pressure (microphone) sensor has a clear unobstructed line of sight to the centre of the blast. The Inspector may allow or require monitoring at specific locations on a case by case basis as may be required.",
        condition_category_code: "HSC",
        parent_standard_permit_condition_id: 564,
        parent_permit_condition_id: 564,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "A signed copy of the Blast Log for each blast and a copy of the Electronic Monitor Record must be maintained at on the mine site. Such records must be made available to the Inspector on request.",
        condition_category_code: "HSC",
        parent_standard_permit_condition_id: 564,
        parent_permit_condition_id: 564,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "To the extent practical, all blasts initiated on the quarry must be videoed, and a copy of the video must be kept at the mine office and made available to the Inspector on request.",
        condition_category_code: "HSC",
        parent_standard_permit_condition_id: 564,
        parent_permit_condition_id: 564,
        condition_type_code: "CON",
        sub_conditions: [
          {
            ...
            condition: "The video file must include the following identification information as a word document:",
            condition_category_code: "HSC",
          ...
          },
          {
            ...
            condition: "the bench/location identification, including a map showing the location on the mine footprint.",
            condition_category_code: "HSC",
            parent_standard_permit_condition_id: 576,
            parent_permit_condition_id: 576,
            condition_type_code: "LIS",
    ...
    sub_conditions: [
      {
        ...
        condition: "Individual roads and trails will be exempted from the requirement for total reclamation if either:",
        condition_category_code: "RCC",
        ...
        sub_conditions: [
          {
            ...
            condition: "It can be demonstrated that an agency of the Crown has accepted responsibility in writing for the operation, maintenance and reclamation of the road or trail; or",
            condition_category_code: "RCC",
          ...
          },
          {
            ...
            condition: "The Chief Permitting Officer provides notification that the road should not be reclaimed due to the use or potential use by other users who will assume liability.",
            condition_category_code: "RCC",
            parent_standard_permit_condition_id: 559,
            parent_permit_condition_id: 559,
            condition_type_code: "LIS",
    ...
    sub_conditions: [
      {
        ...
        condition: "Unless otherwise approved in writing by the Chief Permitting Officer, all reports required to be submitted  under  this  permit  other  than  the  Annual  Summary  of  Exploration  Activities  must  be  signed by a Qualified Professional.",
        condition_category_code: "GEC",
    ...
    sub_conditions: [
      {
        ...
        sub_conditions: [
          ...
          },
          {
            ...
            condition: "If any of the following conditions are met, the timing window is not applicable:",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 482,
            parent_permit_condition_id: 482,
            condition_type_code: "CON",
            sub_conditions: [
              {
                ...
                condition: "If the stream channel is naturally dry (no flow) or frozen to the bottom at the worksite and the instream activity will not adversely impact fish habitat (e.g. result in the introduction of sediment into fish habitat).",
                condition_category_code: "ELC",
              ...
              },
              {
                ...
                condition: "If construction of a winter crossing is proposed and such works does not adversely impact the stream channel (including stream banks), fish habitat or fish passage. ",
                condition_category_code: "ELC",
                parent_standard_permit_condition_id: 484,
                parent_permit_condition_id: 484,
                condition_type_code: "LIS",
              ...
              },
              {
                ...
                condition: "The structure does not encroach below the high-water mark, no work is proposed below the high-water mark of a fish stream, and measures will be taken to prevent the delivery of sediments or contaminants into fish habitat.",
                condition_category_code: "ELC",
                parent_standard_permit_condition_id: 484,
                parent_permit_condition_id: 484,
                condition_type_code: "LIS",
              ...
              },
              {
                ...
                condition: "Work is in a non-fish stream and measures will be taken to prevent the delivery of sediments into downstream fish habitat or the stream is not fish-bearing and discontinuous with no connection to downstream fish habitat.",
                condition_category_code: "ELC",
                parent_standard_permit_condition_id: 484,
                parent_permit_condition_id: 484,
                condition_type_code: "LIS",
        ...
        sub_conditions: [
          {
            ...
            condition: "The original rate of water flow in the stream (existing prior to commencing work) must be maintained upstream and downstream of the worksite during all phases of instream activity associated with the work;",
            condition_category_code: "ELC",
          ...
          },
          {
            ...
            condition: "If the stream is fish-bearing, the culvert allows fish in the stream to pass up or down stream under all flow conditions;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 490,
            parent_permit_condition_id: 490,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "The culvert and its approach roads do not produce a backwater effect or increase the head of the stream;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 490,
            parent_permit_condition_id: 490,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "The culvert is installed in a manner that permits the removal of obstacles and debris within the culvert and at the culvert ends;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 490,
            parent_permit_condition_id: 490,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "Embankment fill materials do not, and are unlikely to, encroach on culvert inlets and outlets;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 490,
            parent_permit_condition_id: 490,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "The culvert has a depth of fill cover that is at least 300 mm or as required by the culvert manufacturers specifications;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 490,
            parent_permit_condition_id: 490,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "The culvert is made of materials that meet the applicable standards of the Canadian Standards Association;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 490,
            parent_permit_condition_id: 490,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "Any stream within the mine site must be assumed to be fish bearing unless determined otherwise by a qualified professional.",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 490,
            parent_permit_condition_id: 490,
            condition_type_code: "CON",
        ...
        sub_conditions: [
          {
            ...
            condition: "The equipment used for site preparation, or for installation, construction, maintenance or removal of the culvert, is situated in a dry stream channel or operated from the top of the bank;",
            condition_category_code: "ELC",
          ...
          },
          {
            ...
            condition: "The permanent removal of stable, naturally occurring material from the stream or stream channel must be minimized and completed only as necessary;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 502,
            parent_permit_condition_id: 502,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "All activities in and about streams must be conducted in a manner that does not cause harm to fish or fish habitat and species at risk or their habitat;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 502,
            parent_permit_condition_id: 502,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "The removal of material must not lead to stream channel instability or increase the risk of sedimentation into the watercourse immediately downstream of the worksite;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 502,
            parent_permit_condition_id: 502,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "Any spoil materials must be deposited in a stable area and in such a way that the excavated material will not contribute sediment or debris to the stream or adversely impact riparian habitats or species at risk and their habitats;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 502,
            parent_permit_condition_id: 502,
            condition_type_code: "CON",
        ...
        sub_conditions: [
          {
            ...
            condition: "The culvert inlet and outlet incorporate measures to protect the structure and the stream channel against erosion;",
            condition_category_code: "ELC",
          ...
          },
          {
            ...
            condition: "Any work associated with the proposed changes in and about a stream must not cause stream channel instability or increase the risk of sedimentation into the stream;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 510,
            parent_permit_condition_id: 510,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "Soil disturbance must not occur in heavy rain conditions and any soil removed must be placed in a location that ensures that sediment or debris does not enter the stream;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 510,
            parent_permit_condition_id: 510,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "Work must be suspended if the sediment control measures are ineffective and result in the introduction of sediment into the stream. In the event of sediment release into a stream, permittees are directed to immediately stabilize and mitigate the release, and then notify the Inspector of Mines.",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 510,
            parent_permit_condition_id: 510,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "During periods of heavy or persistent precipitation, work must stop if continuing the work will result in sediment delivery downstream of the immediate worksite. Measures must be taken to minimize the risk of on-going sediment delivery to the stream during the shutdown period;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 510,
            parent_permit_condition_id: 510,
            condition_type_code: "CON",
        ...
        sub_conditions: [
          {
            ...
            condition: "Damage above the high water mark to values such as banks and stream side (riparian) vegetation in the vicinity of the work area must be minimized. Unavoidable impacts that occur must be remedied as per the reclamation section below;",
            condition_category_code: "ELC",
          ...
          },
          {
            ...
            condition: "Minimize disturbance to natural materials, including but not necessarily limited to embedded logs and boulders, as well as vegetation that contribute to fish and wildlife habitat or stream channel stability;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 520,
            parent_permit_condition_id: 520,
            condition_type_code: "CON",
        ...
        sub_conditions: [
          {
            ...
            condition: "Complete required reclamation works on disturbed areas must be conducted according to the site-specific reclamation plans that will ensure function as close as possible to natural pre-disturbance conditions;",
            condition_category_code: "ELC",
          ...
          },
          {
            ...
            condition: "Any materials, such as riprap or gabion rock, used for stream bank armouring must be clean and not contain substances that could be harmful to fish, wildlife or the aquatic ecosystem of the stream.",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 524,
            parent_permit_condition_id: 524,
            condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Construction, maintenance and removal of clear span bridges is approved subject to the following conditions:",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 413,
        parent_permit_condition_id: 413,
        condition_type_code: "SEC",
        sub_conditions: [
          {
            ...
            condition: "The equipment used for site preparation, or for construction, maintenance or removal of the bridge is situated in a dry stream channel or operated from the top of the bank;",
            condition_category_code: "ELC",
          ...
          },
          {
            ...
            condition: "The bridge and its approach roads do not produce a back water effect or increase the head of the stream;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 528,
            parent_permit_condition_id: 528,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "Bridge abutments or other structures and materials must not be placed within the stream channel width. Rip-rap must be keyed into the stream bank and must not constrict the natural stream channel width;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 528,
            parent_permit_condition_id: 528,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "The hydraulic capacity of the bridge is equivalent to the hydraulic capacity of the stream channel, or is capable of passing the 1 in 200 year maximum daily flow;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 528,
            parent_permit_condition_id: 528,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "The height of the underside of the bridge is adequate to provide free passage of flood debris and ice flows;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 528,
            parent_permit_condition_id: 528,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "The bridge is made of materials that meet the applicable standards of the Canadian Standards Association.",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 528,
            parent_permit_condition_id: 528,
            condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "The construction of a temporary ford for vehicular traffic across a stream, is approved subject to the following conditions:",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 413,
        parent_permit_condition_id: 413,
        condition_type_code: "SEC",
        sub_conditions: [
          {
            ...
            condition: "the construction occurs at a time in the year during which the construction can occur without causing a risk of significant harm to fish, wildlife or the aquatic ecosystem of the stream,",
            condition_category_code: "ELC",
          ...
          },
          {
            ...
            condition: "the 1 in 10 year maximum daily flow over the ford is accommodated without the loss of the ford and without eroding the stream channel,",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 893,
            parent_permit_condition_id: 893,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "any culvert is designed and installed to pass the average low flow for the period of use,",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 893,
            parent_permit_condition_id: 893,
            condition_type_code: "CON",
          ...
          },
          {
            ...
            condition: "the ford is removed at the end of the period of use at a time when the removal can proceed without causing a risk of significant harm to fish, wildlife or the aquatic ecosystem of the stream;",
            condition_category_code: "ELC",
            parent_standard_permit_condition_id: 893,
            parent_permit_condition_id: 893,
            condition_type_code: "CON",
    ...
    sub_conditions: [
      {
        ...
        condition: "At the end of each field season, no more than [X#] drill sites are to be left un-reclaimed.",
        condition_category_code: "ELC",
      ...
      },
      {
        ...
        condition: "At the end of each season, drill site timbers not in use must either be removed from site or neatly stockpiled in one location in the permit area such that they will not be scattered by weather effects.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 414,
        parent_permit_condition_id: 414,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "All equipment brought on to the site must be removed from the permitted mine site by [dd/mm of each year].",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 414,
        parent_permit_condition_id: 414,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "Derelict or damaged equipment, supplies, or materials must not be stored or otherwise left or abandoned anywhere on the permitted mine site.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 414,
        parent_permit_condition_id: 414,
        condition_type_code: "CON",
      ...
      },
      {
        ...
        condition: "At the end of each field season, disturbed areas are to be left in a condition that is neat, clean and safe.",
        condition_category_code: "ELC",
        parent_standard_permit_condition_id: 414,
        parent_permit_condition_id: 414,
        condition_type_code: "CON",
        ...
        sub_conditions: [
          {
            ...
            condition: "[At least 90 days] prior to starting any work under this Permit, a(n) [Plan Name] must be developed and submitted to [Regional Mines Office email] for the approval of the Chief Permitting Officer. The [Plan Name] must be implemented upon commencement of work. <<OR>>",
            condition_category_code: "GOC",
        ...
        sub_conditions: [
          {
            ...
            condition: "[At least 90 days] prior to the commencement of work under this Permit, a(n) [Plan Name] must be developed to the satisfaction of the Chief Permitting Officer. The [Plan Name] must be implemented upon commencement of work.",
            condition_category_code: "GOC",
