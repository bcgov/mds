...
import { AMS_ENVIRONMENTAL_MANAGEMENT_ACT_TYPES, AMS_MINES_ACT_TYPE, PROJECT_SUMMARY_STATUS_CODES } from "@mds/common/constants/enums";
...
const ProjectOverviewTab: FC = () => {
    ...
    const getButtonProps = (recordExists: boolean, editLocked: boolean) => {
        ...
        if (recordExists) {
            buttonProps.text = editLocked ? "Resume" : "View";
        }
        return buttonProps;
    };
