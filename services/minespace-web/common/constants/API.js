...
export const PROJECT_SUMMARIES = (params = {}) => `/project-summaries?${queryString.stringify(params)}`;
export const PROJECT_SUMMARY = (mineGuid, projectSummaryGuid) => `/mines/${mineGuid}/project-summaries/${projectSummaryGuid}`;
