  ...
  <div>
    <Row>
      ...
      <Paragraph>
        ...
        the mining industry across British Columbia. The system is called Mines Digital Services.
      </Paragraph>
      <Paragraph>
    ...
    <Row>
      <Col lg={{ span: 16 }}>
        <Title level={2}>What can I do in BC MineSpace?</Title>
        <Paragraph>
          <ul>
        ...
        <Paragraph>
          ...
          &nbsp;to request access to BC MineSpace.
        </Paragraph>
        <Paragraph>
          If you have multiple employees who need to use BC MineSpace:
          <ol>
            <li>Add them to your Business BCeID</li>
            <li>Let us know you want them to be able to access BC MineSpace</li>
          </ol>
        </Paragraph>
      </Col>
