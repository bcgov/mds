...
/**
 ...
 If R is a type that extends AppThunk with a state of type S, then the ACType type will be a function that takes the same arguments as T, and returns a state of type S.
 Otherwise, the ACType type will be undefined.
