...
export const fetchMineTenureTypes = () => dispatch => {
  ...
  return CustomAxios({
    errorToastMessage: String.ERROR,
    selector: getMineTenureTypeOptions
  })
...
export const fetchPermitStatusOptions = () => dispatch => {
  ...
  return CustomAxios({ selector: getPermitStatusOptions })
    .get(
      `${ENVIRONMENT.apiUrl}${API.PERMITSTATUSCODES()}`,
      createRequestHeader()
    )
    .then(response => {
...
export const fetchIncidentDocumentTypeOptions = () => dispatch => {
  ...
  return CustomAxios({ selector: getIncidentDocumentTypeOptions })
    ...
    .then(response => {
      ...
      dispatch(
        staticContentActions.storeIncidentDocumentTypeOptions(response.data)
      );
    })
    .catch(() =>
      dispatch(error(reducerTypes.GET_INCIDENT_DOCUMENT_TYPE_OPTIONS))
    );
};
...
export const fetchMineIncidentFollowActionOptions = () => dispatch => {
  ...
  return CustomAxios({ selector: getIncidentFollowupActionOptions })
    .get(
      ENVIRONMENT.apiUrl + API.INCIDENT_FOLLOWUP_ACTIONS,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_MINE_INCIDENT_FOLLOWUP_ACTION_OPTIONS));
      dispatch(
        staticContentActions.storeMineIncidentFollowActionOptions(response.data)
      );
    })
    .catch(() =>
      dispatch(error(reducerTypes.GET_MINE_INCIDENT_FOLLOWUP_ACTION_OPTIONS))
    );
};
...
export const fetchMineIncidentDeterminationOptions = () => dispatch => {
  ...
  return CustomAxios({ selector: getIncidentDeterminationOptions })
    .get(
      ENVIRONMENT.apiUrl + API.INCIDENT_DETERMINATION_TYPES,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_MINE_INCIDENT_DETERMINATION_OPTIONS));
      dispatch(
        staticContentActions.storeMineIncidentDeterminationOptions(
          response.data
        )
      );
    })
    .catch(() =>
      dispatch(error(reducerTypes.GET_MINE_INCIDENT_DETERMINATION_OPTIONS))
    );
};
...
export const fetchMineIncidentStatusCodeOptions = () => dispatch => {
  ...
  return CustomAxios({ selector: getIncidentStatusCodeOptions })
    ...
    .then(response => {
      ...
      dispatch(
        staticContentActions.storeMineIncidentStatusCodeOptions(response.data)
      );
    })
    .catch(() =>
      dispatch(error(reducerTypes.GET_MINE_INCIDENT_STATUS_CODE_OPTIONS))
    );
};
...
export const fetchMineIncidentCategoryCodeOptions = () => dispatch => {
  ...
  return CustomAxios({ selector: getIncidentCategoryCodeOptions })
    .get(
      ENVIRONMENT.apiUrl + API.INCIDENT_CATEGORY_CODES,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_MINE_INCIDENT_CATEGORY_CODE_OPTIONS));
      dispatch(
        staticContentActions.storeMineIncidentCategoryCodeOptions(response.data)
      );
    })
    .catch(() =>
      dispatch(error(reducerTypes.GET_MINE_INCIDENT_CATEGORY_CODE_OPTIONS))
    );
};
...
export const fetchVarianceStatusOptions = () => dispatch => {
  ...
  return CustomAxios({ selector: getVarianceStatusOptions })
    .get(
      `${ENVIRONMENT.apiUrl + API.VARIANCE_STATUS_CODES}`,
      createRequestHeader()
    )
    .then(response => {
...
export const fetchVarianceDocumentCategoryOptions = () => dispatch => {
  ...
  return CustomAxios({ selector: getVarianceDocumentCategoryOptions })
    .get(
      `${ENVIRONMENT.apiUrl + API.VARIANCE_DOCUMENT_CATEGORY_OPTIONS}`,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_VARIANCE_DOCUMENT_CATEGORY_OPTIONS));
      dispatch(
        staticContentActions.storeVarianceDocumentCategoryOptions(response.data)
      );
    })
    .catch(() =>
      dispatch(error(reducerTypes.GET_VARIANCE_DOCUMENT_CATEGORY_OPTIONS))
    );
};
...
export const fetchMineReportDefinitionOptions = () => dispatch => {
  ...
  return CustomAxios()
    .get(
      `${ENVIRONMENT.apiUrl}${API.MINE_REPORT_DEFINITIONS()}`,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_MINE_REPORT_DEFINITION_OPTIONS));
      dispatch(
        staticContentActions.storeMineReportDefinitionOptions(response.data)
      );
      return response;
    })
    .catch(() =>
...
export const fetchMineReportStatusOptions = () => dispatch => {
  ...
  return CustomAxios()
    .get(
      `${ENVIRONMENT.apiUrl + API.MINE_REPORT_STATUS}`,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_MINE_REPORT_STATUS_OPTIONS));
      dispatch(
        staticContentActions.storeMineReportStatusOptions(response.data)
      );
      return response;
    })
...
export const fetchNoticeOfWorkActivityTypeOptions = () => dispatch => {
  ...
  return CustomAxios()
    .get(
      `${ENVIRONMENT.apiUrl + API.NOTICE_OF_WORK_ACTIVITY_TYPE_OPTIONS}`,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_NOTICE_OF_WORK_ACTIVITY_TYPE_OPTIONS));
      dispatch(
        staticContentActions.storeNoticeOfWorkActivityTypeOptions(response.data)
      );
      return response;
    })
    .catch(() =>
      dispatch(error(reducerTypes.GET_NOTICE_OF_WORK_ACTIVITY_TYPE_OPTIONS))
    );
};
...
export const fetchNoticeOfWorkUnitTypeOptions = () => dispatch => {
  ...
  return CustomAxios()
    .get(
      `${ENVIRONMENT.apiUrl + API.NOTICE_OF_WORK_UNIT_TYPE_OPTIONS}`,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_NOTICE_OF_WORK_UNIT_TYPE_OPTIONS));
      dispatch(
        staticContentActions.storeNoticeOfWorkUnitTypeOptions(response.data)
      );
      return response;
    })
    .catch(() =>
      dispatch(error(reducerTypes.GET_NOTICE_OF_WORK_UNIT_TYPE_OPTIONS))
    );
};
...
export const fetchNoticeOfWorkApplicationTypeOptions = () => dispatch => {
  ...
  return CustomAxios()
    ...
    .then(response => {
      dispatch(
        success(reducerTypes.GET_NOTICE_OF_WORK_APPLICATION_TYPE_OPTIONS)
      );
      dispatch(
        staticContentActions.storeNoticeOfWorkApplicationTypeOptions(
          response.data
        )
      );
      return response;
    ...
    .catch(() =>
      dispatch(error(reducerTypes.GET_NOTICE_OF_WORK_APPLICATION_TYPE_OPTIONS))
    );
};
...
export const fetchNoticeOfWorkApplicationStatusOptions = () => dispatch => {
  ...
  return CustomAxios()
    ...
    .then(response => {
      dispatch(
        success(reducerTypes.GET_NOTICE_OF_WORK_APPLICATION_STATUS_OPTIONS)
      );
      dispatch(
        staticContentActions.storeNoticeOfWorkApplicationStatusOptions(
          response.data
        )
      );
      return response;
    ...
    .catch(() =>
      dispatch(
        error(reducerTypes.GET_NOTICE_OF_WORK_APPLICATION_STATUS_OPTIONS)
      )
    );
};
...
export const fetchNoticeOfWorkApplicationDocumentTypeOptions = () => dispatch => {
  dispatch(
    request(reducerTypes.GET_NOTICE_OF_WORK_APPLICATION_DOCUMENT_TYPE_OPTIONS)
  );
  return CustomAxios()
    .get(
      `${ENVIRONMENT.apiUrl + API.NOW_APPLICATION_DOCUMENT_TYPE_OPTIONS}`,
      createRequestHeader()
    )
    .then(response => {
      dispatch(
        success(
          reducerTypes.GET_NOTICE_OF_WORK_APPLICATION_DOCUMENT_TYPE_OPTIONS
        )
      );
      dispatch(
        staticContentActions.storeNoticeOfWorkApplicationDocumentTypeOptions(
          response.data
        )
      );
      return response;
    ...
    .catch(() =>
      dispatch(
        error(reducerTypes.GET_NOTICE_OF_WORK_APPLICATION_DOCUMENT_TYPE_OPTIONS)
      )
    );
};
...
export const fetchNoticeOfWorkUndergroundExplorationTypeOptions = () => dispatch => {
  ...
  return CustomAxios()
    ...
    .then(response => {
      dispatch(
        success(reducerTypes.GET_NOW_UNDERGROUND_EXPLORATION_TYPE_OPTIONS)
      );
      dispatch(
        staticContentActions.storeNoticeOfWorkUndergroundExplorationTypeOptions(
          response.data
        )
      );
      return response;
    ...
    .catch(() =>
      dispatch(error(reducerTypes.GET_NOW_UNDERGROUND_EXPLORATION_TYPE_OPTIONS))
    );
};
...
export const fetchNoticeOfWorkApplicationProgressStatusCodes = () => dispatch => {
  ...
  return CustomAxios()
    .get(
      `${ENVIRONMENT.apiUrl + API.NOW_APPLICATION_PROGRESS_STATUS_CODES}`,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_NOW_APPLICATION_PROGRESS_STATUS_CODES));
      dispatch(
        staticContentActions.storeNoticeOfWorkApplicationProgressStatusCodeOptions(
          response.data
        )
      );
      return response;
    ...
    .catch(() =>
      dispatch(error(reducerTypes.GET_NOW_APPLICATION_PROGRESS_STATUS_CODES))
    );
};
...
export const fetchNoticeOfWorkApplicationPermitTypes = () => dispatch => {
  ...
  return CustomAxios()
    .get(
      `${ENVIRONMENT.apiUrl + API.NOW_APPLICATION_PERMIT_TYPES}`,
      createRequestHeader()
    )
    .then(response => {
      dispatch(success(reducerTypes.GET_NOW_APPLICATION_PERMIT_TYPES));
      dispatch(
        staticContentActions.storeNoticeOfWorkApplicationPermitTypesOptions(
          response.data
        )
      );
      return response;
    ...
    .catch(() =>
      dispatch(error(reducerTypes.GET_NOW_APPLICATION_PERMIT_TYPES))
    );
};
...
export const fetchNoticeOfWorkApplicationReviewTypes = () => dispatch => {
  ...
  return CustomAxios()
    ...
    .then(response => {
      dispatch(
        success(reducerTypes.GET_NOTICE_OF_WORK_APPLICATION_REVIEW_TYPES)
      );
      dispatch(
        staticContentActions.storeNoticeOfWorkApplicationReviewTypes(
          response.data
        )
      );
      return response;
    ...
    .catch(() =>
      dispatch(error(reducerTypes.GET_NOTICE_OF_WORK_APPLICATION_REVIEW_TYPES))
    );
};
...
export const fetchPartyRelationshipTypes = () => dispatch => {
  ...
  return CustomAxios()
    .get(
      `${ENVIRONMENT.apiUrl + API.PARTY}/mines/relationship-types`,
      createRequestHeader()
    )
    .then(response => {
