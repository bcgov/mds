...
export const MINE_NAME_LIST = (params = {}) =>
  `/mines/search?${queryString.stringify(params)}`;
...
export const MINE_VERIFIED_STATUS = mine_guid =>
  `/mines/${mine_guid}/verified-status`;
...
export const PERMITAMENDMENTDOCUMENT = (
  mineGuid,
  permitGuid,
  permitAmendmentGuid,
  documentGuid
...
export const VARIANCE = (mineGuid, varianceGuid) =>
...
export const VARIANCE_DOCUMENT = (
  mineGuid,
  varianceGuid,
  documentManagerGuid
) =>
...
export const MINE_INCIDENT_DOCUMENT = mineGuid =>
  `/mines/${mineGuid}/incidents/documents`;
...
export const MINE_REPORT_DOCUMENT = mineGuid =>
...
export const NOTICE_OF_WORK_DOCUMENT_FILE_GET_URL = (
  id,
  applicationGuid,
  token = {}
) =>
  `${NOTICE_OF_WORK_APPLICATION(
    applicationGuid
  )}/document/${id}?${queryString.stringify(token)}`;
...
export const NOTICE_OF_WORK_APPLICATION_UPDATE = applicationGuid =>
  `/now-applications/${applicationGuid}`;
export const NOTICE_OF_WORK_ACTIVITY_TYPE_OPTIONS =
  "/now-applications/activity-types";
export const NOTICE_OF_WORK_UNIT_TYPE_OPTIONS = "/now-applications/unit-types";
export const NOTICE_OF_WORK_APPLICATION_TYPE_OPTIONS =
  "/now-applications/application-types";
export const NOTICE_OF_WORK_APPLICATION_STATUS_OPTIONS =
  "/now-applications/application-status-codes";
export const NOW_APPLICATION_DOCUMENT_TYPE_OPTIONS =
  "/now-applications/application-document-types";
...
export const NOW_APPLICATION_PERMIT_TYPES =
  "/now-applications/application-permit-types";

// Mine Party Appointments
export const MINE_PARTY_APPOINTMENT_DOCUMENTS = (
  mineGuid,
  minePartyAppointmentGuid
) => `/mines/${mineGuid}/party-appts/${minePartyAppointmentGuid}/documents`;

export const NRIS_DOCUMENT_TOKEN_GET_URL = (
  externalId,
  inspectionId,
  file_name
) =>
...
export const NRIS_DOCUMENT_FILE_GET_URL = (externalId, inspectionId, token) =>
  `/compliance/inspection/${inspectionId}/document/${externalId}?${queryString.stringify(
    token
  )}`;
