...
export const REMOVE_DOCUMENT_FROM_RELATIONSHIP =
  "REMOVE_DOCUMENT_FROM_RELATIONSHIP";
...
export const UPDATE_PERMIT_AMENDMENT_DOCUMENT =
  "UPDATE_PERMIT_AMENDMENT_DOCUMENT";
...
export const GET_VARIANCE_DOCUMENT_CATEGORY_OPTIONS =
  "GET_VARIANCE_DOCUMENT_CATEGORY_OPTIONS";
...
export const GET_INCIDENT_DOCUMENT_TYPE_OPTIONS =
  "GET_INCIDENT_DOCUMENT_TYPE_OPTIONS";
export const GET_MINE_INCIDENT_FOLLOWUP_ACTION_OPTIONS =
  "GET_MINE_INCIDENT_FOLLOWUP_ACTION_OPTIONS";
export const GET_MINE_INCIDENT_DETERMINATION_OPTIONS =
  "GET_MINE_INCIDENT_DETERMINATION_OPTIONS";
export const GET_MINE_INCIDENT_STATUS_CODE_OPTIONS =
  "GET_MINE_INCIDENT_STATUS_CODE_OPTIONS";
export const GET_MINE_INCIDENT_CATEGORY_CODE_OPTIONS =
  "GET_MINE_INCIDENT_CATEGORY_CODE_OPTIONS";
...
export const GET_MINE_REPORT_DEFINITION_OPTIONS =
  "GET_MINE_REPORT_DEFINITION_OPTIONS";
...
export const GET_NOTICE_OF_WORK_APPLICATIONS =
  "GET_NOTICE_OF_WORK_APPLICATIONS";
export const GET_NOTICE_OF_WORK_APPLICATION = "GET_NOTICE_OF_WORK_APPLICATION";
export const GET_MINE_NOTICE_OF_WORK_APPLICATIONS =
  "GET_NOTICE_OF_WORK_APPLICATIONS";
export const CREATE_NOTICE_OF_WORK_APPLICATION =
  "CREATE_NOTICE_OF_WORK_APPLICATION";
export const UPDATE_NOTICE_OF_WORK_APPLICATION =
  "UPDATE_NOTICE_OF_WORK_APPLICATION";
export const GET_IMPORTED_NOTICE_OF_WORK_APPLICATION =
  "GET_IMPORTED_NOTICE_OF_WORK_APPLICATION";
export const GET_ORIGINAL_NOTICE_OF_WORK_APPLICATION =
  "GET_ORIGINAL_NOTICE_OF_WORK_APPLICATION";
export const GET_NOTICE_OF_WORK_ACTIVITY_TYPE_OPTIONS =
  "GET_NOTICE_OF_WORK_ACTIVITY_TYPE_OPTIONS";
export const GET_NOTICE_OF_WORK_UNIT_TYPE_OPTIONS =
  "GET_NOTICE_OF_WORK_UNIT_TYPE_OPTIONS";
...
export const CREATE_NOTICE_OF_WORK_APPLICATION_REVIEW =
  "CREATE_NOTICE_OF_WORK_APPLICATION_REVIEW";
export const GET_NOTICE_OF_WORK_APPLICATION_REVIEW =
  "GET_NOTICE_OF_WORK_APPLICATION_REVIEW";
export const UPDATE_NOTICE_OF_WORK_APPLICATION_REVIEW =
  "UPDATE_NOTICE_OF_WORK_APPLICATION_REVIEW";
export const GET_NOTICE_OF_WORK_APPLICATION_REVIEW_TYPES =
  "GET_NOTICE_OF_WORK_APPLICATION_REVIEW_TYPES";
export const REMOVE_NOTICE_OF_WORK_APPLICATION_REVIEW =
  "REMOVE_NOTICE_OF_WORK_APPLICATION_REVIEW";
...
export const GET_NOW_APPLICATION_PERMIT_TYPES =
  "GET_NOW_APPLICATION_PERMIT_TYPES";
