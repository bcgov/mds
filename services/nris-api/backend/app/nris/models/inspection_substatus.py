...
class InspectionSubstatus(Base):
    ...
    __table_args__ = {
        'comment':
        'Lookup table that contains a list of inspection substatuses. E.g. Open, Closed, Report Sent, Response Recieved, '
    }
    inspection_substatus_id = db.Column(db.Integer, primary_key=True)
    inspection_substatus_code = db.Column(db.String(10485760), nullable=False)
    inspection_substatus_description = db.Column(db.String(10485760))
