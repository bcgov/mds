...
from app.api.parties.party.resources.party_bc_registration_list_resource import PartyBCRegistrationListResource
...
api.add_resource(PartyBCRegistrationListResource, '/<string:party_guid>/bc-registration')
