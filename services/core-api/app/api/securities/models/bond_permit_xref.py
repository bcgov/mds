...
class BondPermitXref(Base):
    ...
    bond_id = db.Column(db.Integer, db.ForeignKey('bond.bond_id'), server_default=FetchedValue())
    permit_id = db.Column(
        db.Integer, db.ForeignKey('permit.permit_id'), server_default=FetchedValue())
