...
from app.api.compliance.resources.compliance_article_list import ComplianceArticleListResource
...
api.add_resource(ComplianceArticleListResource, '/codes/new')
