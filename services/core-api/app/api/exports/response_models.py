...
from app.api.projects.response_models import PROJECT_SUMMARY_STATUS_CODE_MODEL, PROJECT_SUMMARY_DOCUMENT_TYPE_MODEL, PROJECT_SUMMARY_AUTHORIZATION_TYPE_MODEL, PROJECT_SUMMARY_PERMIT_TYPE_MODEL, IRT_STATUS_CODE_MODEL, IRT_DOCUMENT_TYPE_MODEL, MAJOR_MINE_APPLICATION_STATUS_CODE_MODEL, MAJOR_MINE_APPLICATION_DOCUMENT_TYPE_MODEL, MAJOR_MINE_APPLICATION_DOCUMENT_SUBTYPE_MODEL, PROJECT_DECISION_PACKAGE_STATUS_CODE_MODEL, PROJECT_DECISION_PACKAGE_DOCUMENT_TYPE_MODEL
...
STATIC_CONTENT_MODEL = api.model(
    'StaticContentModel', {
        ...
        fields.List(fields.Nested(NOTICE_OF_WORK_TIER), attribute='NoticeOfWorkTier'),
        'noticeOfWorkNationEventOptions':
        fields.List(fields.Nested(NOW_APPLICATION_NATION_EVENT_CODE), attribute='NOWApplicationNationEventCode'),
        'noticeOfWorkNationStatusOptions':
        fields.List(fields.Nested(NOW_APPLICATION_NATION_STATUS), attribute='NOWApplicationNationStatus'),
        ...
        'majorMineApplicationDocumentSubtypes':
        fields.List(
            fields.Nested(MAJOR_MINE_APPLICATION_DOCUMENT_SUBTYPE_MODEL),
            attribute='MajorMineApplicationDocumentSubtype'),
        ...
        fields.List(
            fields.Nested(SPATIAL_BUNDLE_PURPOSE_CODE_MODEL),
            attribute='SpatialBundlePurposeCode'),
    })
