...
STATIC_CONTENT_MODEL = api.model(
    'StaticContentModel', {
        ...
        fields.List(
            fields.Nested(PROJECT_PERMIT_PACKAGE_STATUS_CODE_MODEL),
            attribute='ProjectPermitPackageStatusCode'),
        'projectPermitPackageDocumentTypes':
        fields.List(
            fields.Nested(PROJECT_PERMIT_PACKAGE_DOCUMENT_TYPE_MODEL),
            attribute='ProjectPermitPackageDocumentType'),
        'EMLIContactTypes':
        fields.List(
