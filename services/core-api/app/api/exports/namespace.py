...
from app.api.exports.now_application.resources.now_application_gis_export_resource import NowApplicationGisExport
...
api.add_resource(NowApplicationGisExport, '/now-application-gis-export')
