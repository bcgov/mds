...
from app.api.projects.project.resources.project import ProjectResource, ProjectListResource, MajorProjectListDashboardResource
...
api.add_resource(MajorProjectListDashboardResource, '/dashboard')
