...
class ProjectSummaryDocumentXref(Base):
    __tablename__ = 'project_summary_document_xref'

    project_summary_document_xref_guid = db.Column(
    ...
    project_summary_id = db.Column(
        db.Integer, db.ForeignKey('project_summary.project_summary_id'), nullable=False)
