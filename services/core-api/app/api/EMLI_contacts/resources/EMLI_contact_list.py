...
class EMLIContactListResource(Resource, UserMixin):
    ...
    def post(self):
        ...
        general_contacts = EMLIContact.find_EMLI_general_contacts()
        ...
        unique_global = [contact.emli_contact_type_code for contact in general_contacts]
        unique_global.append(mmo_contact.emli_contact_type_code)
