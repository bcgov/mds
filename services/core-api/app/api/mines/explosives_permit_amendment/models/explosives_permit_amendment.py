...
#
# class ExplosivesPermitAmendment(ExplosivesPermit):
...
#         UUID(as_uuid=True), ForeignKey('explosives_permit.explosives_permit_guid'), nullable=False)
#
#     explosives_permit = db.relationship(
#         'ExplosivesPermit',
#         primaryjoin='ExplosivesPermit.explosives_permit_guid == ExplosivesPermitAmendment.explosives_permit_guid',
