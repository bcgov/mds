...
class PermitConditionsListResource(Resource, UserMixin):
    ...
    def post(self, mine_guid, permit_guid, permit_amendment_guid):
        ...
        if not (permit_amendment.is_generated_in_core and permit_amendment.permit_amendment_status_code != "DFT" or 
            permit_amendment.is_generated_in_core == False and permit_amendment.permit_amendment_status_code == "DFT"):
