...
from app.api.mines.permits.nod.resources.nod_list import NodListResource
...
api.add_resource(ProjectSummaryDocumentUploadResource,
                 '/<string:mine_guid>/project-summaries/<string:project_summary_guid>/documents')
