...
from app.api.mines.documents.resources.mine_document_resource import (
    MineDocumentArtifactRegistrationResource,
...
api.add_resource(MineDocumentArtifactRegistrationResource, '/documents/<string:source_document_manager_guid>/artifact')
