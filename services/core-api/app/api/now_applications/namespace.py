...
from app.api.now_applications.resources.now_application_review_resource import NOWApplicationReviewResource
...
api.add_resource(NOWApplicationReviewResource, '/<string:application_guid>/review')
