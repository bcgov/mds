...
class NOWApplicationNationEventCodeResource(Resource, UserMixin):
    @api.doc(
        description='Get the list of active NoW application nation event codes')
    ...
    def get(self):
        ...
        return NOWApplicationNationEventCode.get_all()
