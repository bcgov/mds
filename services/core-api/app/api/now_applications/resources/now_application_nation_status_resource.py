...
from app.api.now_applications.response_models import NOW_APPLICATION_NATION_STATUS
...
class NOWApplicationNationStatusResource(Resource, UserMixin):
    ...
    @api.marshal_with(NOW_APPLICATION_NATION_STATUS, code=200, envelope='records', as_list=True)
    def get(self):
