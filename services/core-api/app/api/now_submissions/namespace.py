...
from app.api.now_submissions.resources.application_status_resource import ApplicationStatusResource, ApplicationStatusUpdatesSinceResource
...
api.add_resource(ApplicationStatusUpdatesSinceResource,
                 '/applications/status/<string:status_updated_date>')
