...
class Application(Base):
    ...
    permitstatus = db.Column(db.String)
    ...
    descriptionofwork = db.Column(db.String)
    timbermerchantablevolume = db.Column(db.Numeric(14, 2))
    hasproposedcrossings = db.Column(db.String)
    proposedcrossingschanges = db.Column(db.String)
    wastewaterplan = db.Column(db.String)
