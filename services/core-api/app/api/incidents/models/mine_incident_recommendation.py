...
class MineIncidentRecommendation(SoftDeleteMixin, AuditMixin, Base):
    ...
    mine_incident_recommendation_guid = db.Column(
    ...
    def find_by_mine_incident_recommendation_guid(cls, _id):
        try:
            ...
            return cls.query.filter_by(mine_incident_recommendation_guid=_id).filter_by(
