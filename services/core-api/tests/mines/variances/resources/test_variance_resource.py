...
class TestGetMineVariance:
    ...
    def test_get_variance_invalid_variance_guid(self, test_client, db_session, auth_headers):
        ...
        get_resp = test_client.get(
            f'/mines/{variance.mine_guid}/variances/1234', headers=auth_headers['full_auth_header'])
        get_data = json.loads(get_resp.data.decode())
...
class TestPutMineVariance:
    ...
    def test_put_variance(self, test_client, db_session, auth_headers):
        ...
        assert put_data['variance_application_status_code'] == data[
    ...
    def test_put_variance_application_non_existent_variance_guid(self, test_client, db_session,
                                                                 auth_headers):
    ...
    def test_put_variance_application_invalid_variance_guid(self, test_client, db_session,
                                                            auth_headers):
    ...
    def test_put_approved_variance_missing_inspector_party_guid(self, test_client, db_session,
                                                                auth_headers):
    ...
    def test_put_denied_variance_missing_inspector_party_guid(self, test_client, db_session,
                                                              auth_headers):
    ...
    def test_put_variance_application_with_expiry_date(self, test_client, db_session, auth_headers):
        ...
        variance = VarianceFactory()
        approved_variance = VarianceFactory(approved=True)
        data = {'expiry_date': approved_variance.expiry_date}
    ...
    def test_put_variance_application_with_issue_date(self, test_client, db_session, auth_headers):
        ...
        denied_variance = VarianceFactory(denied=True)
        approved_variance = VarianceFactory(approved=True)
        data = {'issue_date': approved_variance.issue_date}
    ...
    def test_put_not_applicable_variance_with_expiry_date(self, test_client, db_session,
                                                          auth_headers):
    ...
    def test_put_not_applicable_variance_with_issue_date(self, test_client, db_session,
                                                         auth_headers):
