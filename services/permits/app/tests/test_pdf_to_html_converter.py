...
def test_run_with_pdf_read_error():
    converter = PDFToTextConverter()
    with patch('app.permit_conditions.converters.pdf_to_text_converter.PdfReader') as mock_pdf_reader:
