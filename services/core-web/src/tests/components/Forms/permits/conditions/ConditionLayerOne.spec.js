...
describe("ConditionLayerOne", () => {
  it("renders properly", () => {
    const { container: component } = render(<BrowserRouter><ReduxWrapper initialState={initialState}><ConditionLayerOne {...dispatchProps} {...props} /></ReduxWrapper></BrowserRouter>);
