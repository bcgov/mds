...
export class NoticeOfWorkApplication extends Component {
  ...
  render() {
    ...
    return (
      ...
      //             {/* <Steps current={this.state.currentStep} onChange={this.handleStepChange}>
      //               {headerSteps}
      //             </Steps> */}
      //             <Tabs activeKey="history" size="large" animated={{ inkBar: true, tabPane: false }}>
      //               <TabPane tab="Verification" key="history">
      //                 {this.renderStepOne()}
      ...
      //                 </div> */}
      //               </TabPane>
      //               <TabPane tab="Technical Review" key="history">
      //                 {this.renderStepTwo()}
      //               </TabPane>
      //               <TabPane tab="Draft Permit" key="history">
      //                 {/* {this.renderPermitGeneration()} */}
      //                 {/* <div className="tab__content ">
      //                   <Table
      //                   align="left"
      ...
      //                 </div> */}
      //               </TabPane>
      //               <TabPane tab="Referral/Consultation" key="history">
      ...
      //                 </div> */}
      //               </TabPane>
      //               <TabPane tab="Administrative" key="history">
      //                 {/* <div className="tab__content ">
      //                   <Table
      //                     align="left"
      //                     pagination={false}
