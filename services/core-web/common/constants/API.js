...
export const NOTICES_OF_DEPARTURE = (mineGuid, permitGuid) =>
  `/mines/${mineGuid}/permits/${permitGuid}/notice-of-departures`;
export const FETCH_NOTICES_OF_DEPARTURE = (mineGuid) => `/mines/${mineGuid}/notice-of-departures`;
