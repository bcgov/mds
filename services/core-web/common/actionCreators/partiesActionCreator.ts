...
export const createParty =
  (payload: ICreateParty): AppThunk<Promise<AxiosResponse<IParty>>> =>
  (dispatch): Promise<AxiosResponse<IParty>> => {
...
export const updateParty =
  (payload: Partial<ICreateParty>, partyGuid: string): AppThunk<Promise<AxiosResponse<IParty>>> =>
  (dispatch): Promise<AxiosResponse<IParty>> => {
...
export const fetchParties =
  (params: IPartyFetchParams = {}): AppThunk =>
  (dispatch) => {
...
export const addPartyRelationship =
  (payload: IAddPartyAppt, successMessage?: string): AppThunk<Promise<AxiosResponse<IPartyAppt>>> =>
  (dispatch): Promise<AxiosResponse<IPartyAppt>> => {
...
export const fetchPartyRelationships =
  (params: IPartyApptFetchParams): AppThunk<Promise<IPartyAppt[]>> =>
  (dispatch): Promise<IPartyAppt[]> => {
...
export const fetchAllPartyRelationships =
  (params: IPartyApptFetchParams): AppThunk =>
  (dispatch) => {
    dispatch(request(reducerTypes.FETCH_PARTY_RELATIONSHIPS));
    dispatch(showLoading());
    return CustomAxios()
...
export const removePartyRelationship =
  (mine_party_appt_guid: string): AppThunk<Promise<AxiosResponse<string>>> =>
...
export const deleteParty =
  (party_guid: string): AppThunk<Promise<AxiosResponse<string>>> =>
  (dispatch): Promise<AxiosResponse<string>> => {
...
export const setAddPartyFormState =
  (addPartyFormState: IAddPartyFormState): AppThunk<Promise<IAddPartyFormState>> =>
  (dispatch): Promise<IAddPartyFormState> => {
...
export const createPartyOrgBookEntity =
  ...
  ): AppThunk<Promise<AxiosResponse<IPartyOrgBookEntity>>> =>
  (dispatch) => {
...
export const mergeParties =
  (payload: IMergeParties): AppThunk<Promise<AxiosResponse<IParty>>> =>
  (dispatch): Promise<AxiosResponse<IParty>> => {
