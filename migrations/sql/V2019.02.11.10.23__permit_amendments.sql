...
(select permit_guid from permit where permit_no = (select permit_no from temp_old_permit where mine_party_appt.permit_guid=temp_old_permit.permit_guid) limit 1)
