DO $$                  
BEGIN 
	IF (SELECT to_regclass('public.mine_incident_determination_type') is null) THEN
		...
		ALTER TABLE mine_incident ADD COLUMN determination_type_code character varying(3);
