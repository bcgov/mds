...
ALTER TABLE public.amendment_reason_xref ADD CONSTRAINT amendment_reason_xref_application_id_fkey FOREIGN KEY (now_application_id) REFERENCES now_application(now_application_id);
