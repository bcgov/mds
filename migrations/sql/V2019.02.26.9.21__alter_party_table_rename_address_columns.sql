...
ALTER TABLE party RENAME province_code TO sub_division_code;
ALTER TABLE party RENAME postal_code   TO post_code;
ALTER TABLE party
    RENAME CONSTRAINT "party_province_code_fkey" TO "party_sub_division_code_fkey";
...
ALTER TABLE province_code RENAME TO sub_division_code;
ALTER TABLE sub_division_code RENAME province_code TO sub_division_code;
