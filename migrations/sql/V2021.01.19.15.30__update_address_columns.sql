...
-- cannot update type if a view relys on the column - Thus dropping and re-creating the view to update the data type
ALTER TABLE address ALTER COLUMN post_code TYPE varchar(10);
ALTER TABLE address ALTER COLUMN suite_no TYPE varchar(10);
