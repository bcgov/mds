...
(report_name, due_date_type, due_date_period, compliance_act, compliance_section, compliance_sub_section, compliance_paragraph,compliance_sub_paragraph)
VALUES 
...
INSERT INTO mine_report_category_xref (mine_report_definition_id, mine_report_category) values ((SELECT x.mine_report_definition_id from mine_report_definition x where report_name = 'Factor of Safety Justification' LIMIT 1), 'H&S') ON CONFLICT DO NOTHING; --PRIVATE, NOT MINESPACE
...
INSERT INTO mine_report_category_xref (mine_report_definition_id, mine_report_category) values ((SELECT x.mine_report_definition_id from mine_report_definition x where report_name = 'Design Slopes Justification' LIMIT 1), 'H&S') ON CONFLICT DO NOTHING; --PRIVATE, NOT MINESPACE
