...
GRANT ALL PRIVILEGES ON SCHEMA now TO mds;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA now TO mds;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA now TO mds;
