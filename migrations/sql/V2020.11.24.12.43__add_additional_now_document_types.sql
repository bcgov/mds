...
VALUES
    ...
    ('SRE', 'Status Report', true, NULL, 'system-mds', 'system-mds'),
    ('SOM', 'Status Report - Overlapping Interests Maps', true, 'MDO', 'system-mds', 'system-mds'),
    ('SRS', 'Status Report - Shape Files', true, NULL, 'system-mds', 'system-mds'),
