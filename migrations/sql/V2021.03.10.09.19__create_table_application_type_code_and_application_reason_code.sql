...
CREATE TABLE IF NOT EXISTS public.application_reason_code (
...
ALTER TABLE public.application_reason_code OWNER TO mds;
ALTER TABLE ONLY application_reason_code
ADD CONSTRAINT application_reason_code_pkey PRIMARY key (application_reason_code);
