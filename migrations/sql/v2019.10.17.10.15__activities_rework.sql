...
ALTER TABLE settling_pond DROP COLUMN reclamation_description, DROP COLUMN reclamation_cost, DROP COLUMN total_disturbed_area, DROP COLUMN total_disturbed_area_unit_type_code;
ALTER TABLE surface_bulk_surface DROP COLUMN reclamation_description, DROP COLUMN reclamation_cost, DROP COLUMN total_disturbed_area, DROP COLUMN total_disturbed_area_unit_type_code;
...
CREATE TABLE IF NOT EXISTS activity_type  (
  activity_type    varchar(3) PRIMARY KEY, 
