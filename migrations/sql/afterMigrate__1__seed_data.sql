...
VALUES
  (nextval('emli_contact_id_seq'),'MMO', null,null,null,'PermRecl@gov.bc.ca',null,null,null,null,true, false, false),
  (nextval('emli_contact_id_seq'),'CHI', null,'Hermanus','Henning','hermanus.henning@gov.bc.ca','778-974-5980',null,null,null,true, true, false),
  (nextval('emli_contact_id_seq'),'CHP', null,'George','Warnock','brittanytownsend@gov.bc.ca','250-649-4339',null,null,null,true, true, false),
  (nextval('emli_contact_id_seq'),'SHI','NW','Doug','Flynn','doug.flynn@gov.bc.ca','250-877-9747',null,null,null, false, false, false),
  (nextval('emli_contact_id_seq'),'RDR','NW','Howard','Davies','howard.davies@gov.bc.ca','250-876-8327',null,null,null, false, false, false),
  (nextval('emli_contact_id_seq'),'ROE','NW',null, null,'MMD-Smithers@gov.bc.ca','250 847-7383','250 847-7603','2nd Floor, 3726 Alfred Avenue','Smithers, B.C. V0J 2N0', false, false, false),
  (nextval('emli_contact_id_seq'),'HSI','NW','Megan', 'Frederick','Megan.Frederick@gov.bc.ca','250-847-7214',null,null,null, true, false, false),
  (nextval('emli_contact_id_seq'),'SPI','NW','Barry', 'MacCallum','Barry.MacCallum@gov.bc.ca','250-876-7041',null,null,null, true, false, false),

  (nextval('emli_contact_id_seq'),'SHI','SW','Chris','Crawford','chris.crawford@gov.bc.ca','236-478-2428',null,null,null,false, false, false),
  (nextval('emli_contact_id_seq'),'SPI','SW', 'Don','Harrison','donald.harrison@gov.bc.ca','778-698-7014',null,null,null, false, false, false),
  (nextval('emli_contact_id_seq'),'RDR','SW','Matthew','MacLean','matthew.maclean@gov.bc.ca','778-698-3649',null,null,null, false, false, false),
  (nextval('emli_contact_id_seq'),'ROE','SW', null, null,'SouthwestMinesDivision@gov.bc.ca','778 698-3649','250 953-3878','PO Box 9395, Stn Prov Govt','Victoria, B.C. V8W 9M9', false, false, false),
  (nextval('emli_contact_id_seq'),'HSI','SW','Blythe', 'Golobic','Blythe.Golobic@gov.bc.ca','250-371-3915',null,null,null, true, false, false),

  (nextval('emli_contact_id_seq'),'SHI','SC','Chris','LeClair','chris.leclair@gov.bc.ca','778-220-2076',null,null,null, false, false, false),
  (nextval('emli_contact_id_seq'),'SPI','SC','Mike','Cloet','mike.cloet@gov.bc.ca','250-312-7314',null,null,null,false, false, false),
  (nextval('emli_contact_id_seq'),'RDR','SC','Ross','Hyam','ross.hyam@gov.bc.ca','250-985-0042',null,null,null,false, false, false),
  (nextval('emli_contact_id_seq'),'ROE','SC',null, null, 'MMD-Kamloops@gov.bc.ca','250 371-3912','','2nd Floor, 441 Columbia Street','Kamloops, B.C. V2C 2T3', false, false, false),
  (nextval('emli_contact_id_seq'),'HSI','SC','Blythe', 'Golobic','Blythe.Golobic@gov.bc.ca','250-371-3915',null,null,null, true,false, false),

  (nextval('emli_contact_id_seq'),'SHI','NE','Brian','Oke','brian.oke@gov.bc.ca','250-565-4387',null,null,null, false, false, false),
  (nextval('emli_contact_id_seq'),'SPI','NE','Todd','Wikjord','todd.wikjord@gov.bc.ca','250-565-4234',null,null,null, false, false, false),
  (nextval('emli_contact_id_seq'),'RDR','NE','Marnie','Fraser','marnie.fraser@gov.bc.ca','250-565-4206',null,null,null, false, false, false),
  (nextval('emli_contact_id_seq'),'ROE','NE',null, null, 'MMD-PrinceGeorge@gov.bc.ca','250 565-4240','250 565-4328','350-1011 4th Avenue','Prince George, B.C. V2L 3H9', false, false, false),
  (nextval('emli_contact_id_seq'),'HSI','NE','Kristopher', 'Bailey','Kristopher.Bailey@gov.bc.ca','250-565-4271',null,null,null, true, false, false),

  (nextval('emli_contact_id_seq'),'SHI','SE','Jerrold','Jewsbury','jerrold.jewsbury@gov.bc.ca','250-417-6007',null,null,null, false, false, false),
  (nextval('emli_contact_id_seq'),'SPI','SE', 'Glen','Hendrickson','glen.hendrickson@gov.bc.ca','250-420-6336',null,null,null,false, false, false),
  (nextval('emli_contact_id_seq'),'RDR','SE','Kathie','Wagar','kathie.wagar@gov.bc.ca','250-417-6011',null,null,null,false, false, false),
  (nextval('emli_contact_id_seq'),'ROE','SE',null, null, 'MMD-Cranbrook@gov.bc.ca','250 417-6134','','202-100 Cranbrook Street North','Cranbrook, B.C. V1C 3P9', false, false, false),
  (nextval('emli_contact_id_seq'),'HSI','SE', 'Alan', 'Day','Alan.Day@gov.bc.ca','250-417-6013',null,null,null, true, false, false)
  ON CONFLICT DO NOTHING;
