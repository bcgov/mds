...
UPDATE now_application now1 SET status_updated_date =
    (SELECT submitted_date FROM now_application now2 WHERE now1.now_application_id = now2.now_application_id)
