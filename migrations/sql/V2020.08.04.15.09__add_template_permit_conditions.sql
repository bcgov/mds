...
-- -- General -- condition === 'Compliance with Mines Act and Code'
-- INSERT INTO standard_permit_conditions
-- (permit_type, parent_standard_permit_condition_id, condition, condition_category, condition_type, display_order, create_user, update_user)
-- VALUES
-- -- General
-- 	('SAG', <<permit_id>>, 'The Permittee shall ensure that all work is in compliance with all sections and parts of the Mines Act and the Health, Safety and Reclamation Code for Mines in B.C. (Code), and the Permittee shall obey all orders issued by the Chief Inspector or the Chief Inspector’s delegate.', 'GEC', 'CON', 1, 'system-mds', 'system-mds')
-- on conflict do nothing;

-- -- General -- condition === 'Changes to Permitted Activities and Amendment of the Permit'
-- INSERT INTO standard_permit_conditions
-- (permit_type, parent_standard_permit_condition_id, condition, condition_category, condition_type, display_order, create_user, update_user)
-- VALUES
-- -- General
-- 	('SAG', <<permit_id>>, 'The owner, agent or manager (herein called the Permittee) shall notify the Chief Inspector in writing of any intention to depart from the approved Application and this Mines Act permit <<permit_no>> to any substantial degree, and shall not proceed to implement the proposed changes without the written authorization of the Chief Inspector or their delegate', 'GEC', 'CON', 1, 'system-mds', 'system-mds'),
--   ('SAG', <<permit_id>>, 'The Chief Inspector reserves the right to amend the conditions set forth in Mines Act permit <<permit_no>>', 'GEC', 'CON', 2, 'system-mds', 'system-mds'),
-- on conflict do nothing;