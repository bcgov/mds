...
from (select pa.permit_amendment_id, atc.description 
	  ...
	  where pa.permit_amendment_status_code = 'DFT' and
      		...
      		pa.preamble_text ='' and
      		pa.mine_guid = nai.mine_guid and
