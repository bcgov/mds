...
-- Authors: Arturo, Ben Harrington and Will Sonnex


-- Has to be kept seperately and run because this view depends on schemas (eg: NRIS) don't exist in the test migration process. 
