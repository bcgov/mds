import { KEYCLOAK } from "./environment";
...
export const SSO_CLIENT_ID = `${KEYCLOAK.clientId}`;
export const SITEMINDER_BASE_URL = `${KEYCLOAK.siteminderURL}`;
...
export const GET_TOKEN_FROM_SSO = `${KEYCLOAK.url}${OPEN_ID_CONNECT_URL}/token`;
export const GET_USER_INFO_FROM_SSO = `${KEYCLOAK.url}${OPEN_ID_CONNECT_URL}/userinfo`;
export const SSO_BASE_AUTH_ENDPOINT = `${KEYCLOAK.url}${OPEN_ID_CONNECT_URL}`;
