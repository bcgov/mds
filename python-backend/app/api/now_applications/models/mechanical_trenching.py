...
class MechanicalTrenching(Base, AuditMixin):
    __tablename__ = "mechanical_trenching"

    mechanical_trenching_id = db.Column(db.Integer, primary_key=True, server_default=FetchedValue())
    ...
    def __repr__(self):
        return '<MechanicalTrenching %r>' % self.mechanical_trenching_id
