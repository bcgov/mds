...
from ..compliance.resources.compliance import MineComplianceResource, MineComplianceSummaryResource
...
api.add_resource(MineComplianceResource, '/<string:mine_no>/compliance')
