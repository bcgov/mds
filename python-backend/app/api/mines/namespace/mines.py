...
from app.api.mine.resources.mine_verified_status import MineVerifiedStatus
...
api.add_resource(MineVerifiedStatus, '/verified-status', '/verified-status/<string:mine_guid>')
