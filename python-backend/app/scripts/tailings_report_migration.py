...
src_table = etl.fromdb(
    connection,
    'SELECT exp_doc.mine_guid, req_doc.req_document_name, exp_doc.due_date, exp_doc_x.mine_document_guid, exp_doc.create_user, exp_doc.create_timestamp, exp_doc.update_user, exp_doc.update_timestamp from mine_expected_document exp_doc \
...
mine_report = etl.cutout(table1, 'mine_document_guid')
mine_report = etl.addfield(mine_report, 'submission_year', 2019)
print(mine_report)

#truncate and load
etl.todb(mine_report, connection, 'mine_report')
