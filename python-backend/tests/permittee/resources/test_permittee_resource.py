...
def test_get_permittee_not_found(test_client, auth_headers):
    get_resp = test_client.get('/permits/permittees/' + TEST_MINE_GUID, headers=auth_headers['full_auth_header'])
...
def test_get_permittee(test_client, auth_headers):
    get_resp = test_client.get('/permits/permittees/' + TEST_PERMITTEE_GUID, headers=auth_headers['full_auth_header'])
    get_data = json.loads(get_resp.data.decode())
...
def test_post_permittee_unexpected_id_in_url(test_client, auth_headers):
    post_resp = test_client.post('/permits/permittees/unexpected_id', headers=auth_headers['full_auth_header'])
...
def test_post_permittee_no_party(test_client, auth_headers):
    ...
    post_resp = test_client.post('/permits/permittees', data=data, headers=auth_headers['full_auth_header'])
    post_data = json.loads(post_resp.data.decode())
