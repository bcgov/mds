...
from tests.factories import MineFactory, NOWApplicationFactory
...
class TestGetMineApplicationResource:
    ...
    def test_get_mine_application_list_filter_by_status(self, test_client, db_session, auth_headers):
        ...
        mine = MineFactory(minimal=True)
        application_1 = NOWApplicationFactory(mine=mine, status='Approved')
        application_2 = NOWApplicationFactory(mine=mine, status='Received')
        application_3 = NOWApplicationFactory(mine=mine, status='Rejected')
        application_4 = NOWApplicationFactory(mine=mine, status='Rejected')
    ...
    def test_get_mine_application_list_filter_by_noticeofworktype(self, test_client, db_session, auth_headers):
        ...
        mine = MineFactory(minimal=True)
        application_1 = NOWApplicationFactory(mine=mine, noticeofworktype='dog')
        application_2 = NOWApplicationFactory(mine=mine, noticeofworktype='dog')
        application_3 = NOWApplicationFactory(mine=mine, noticeofworktype='cat')
        application_4 = NOWApplicationFactory(mine=mine, noticeofworktype='parrot')
    ...
    def test_get_mine_application_list_filter_by_trackingnumber(self, test_client, db_session, auth_headers):
        ...
        mine = MineFactory(minimal=True)
        application_1 = NOWApplicationFactory(mine=mine, trackingnumber=1)
        application_2 = NOWApplicationFactory(mine=mine, trackingnumber=1)
        application_3 = NOWApplicationFactory(mine=mine, trackingnumber=12)
        application_4 = NOWApplicationFactory(mine=mine, trackingnumber=10305)
    ...
    def test_get_mine_application_list_filter_by_multiple_filters(self, test_client, db_session, auth_headers):
        ...
        mine = MineFactory(minimal=True)
        application_1 = NOWApplicationFactory(mine=mine, status='Rejected', noticeofworktype='dog', trackingnumber=1)
        application_2 = NOWApplicationFactory(mine=mine, status='Received', noticeofworktype='cat', trackingnumber=1)
        application_3 = NOWApplicationFactory(mine=mine, status='Rejected', noticeofworktype='dog', trackingnumber=12)
        application_4 = NOWApplicationFactory(mine=mine, status='Approved', noticeofworktype='cat', trackingnumber=10305)
