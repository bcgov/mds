...
def test_get_mines_by_list_search_by_name(test_client, auth_headers):
    get_resp = test_client.get(
        '/mines/search?name=' + TEST_MINE_NAME, headers=auth_headers['full_auth_header'])
    get_data = json.loads(get_resp.data.decode())
    context = {
        'mine_guid': TEST_MINE_GUID,
        'mine_name': TEST_MINE_NAME,
...
def test_get_mines_by_list_search_term_name(test_client, auth_headers):
    get_resp = test_client.get(
        '/mines/search?term=' + TEST_MINE_NAME, headers=auth_headers['full_auth_header'])
    get_data = json.loads(get_resp.data.decode())
    context = {
        'mine_guid': TEST_MINE_GUID,
        'mine_name': TEST_MINE_NAME,
...
def test_get_mines_by_list_search_by_mine_no(test_client, auth_headers):
    get_resp = test_client.get(
        '/mines/search?term=' + TEST_MINE_NO, headers=auth_headers['full_auth_header'])
    get_data = json.loads(get_resp.data.decode())
    context = {
        'mine_guid': TEST_MINE_GUID,
        'mine_name': TEST_MINE_NAME,
...
def test_get_mines_by_list_search_by_permit_no(test_client, auth_headers):
    get_resp = test_client.get(
        '/mines/search?term=TEST56789012', headers=auth_headers['full_auth_header'])
    get_data = json.loads(get_resp.data.decode())
    context = {
        'mine_guid': TEST_MINE_GUID,
        'mine_name': TEST_MINE_NAME,
