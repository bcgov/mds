...
BEGIN
    ...
    INSERT INTO party
    VALUES
        (PARTY_GUID3, FIRST_NAME3, SUR_NAME3, PHONE3, EXT3, EMAIL3, IDIR_USER, DEFAULT, IDIR_USER, DEFAULT, MIDDLE_NAME, 'PER'),
        (PARTY_GUID4, FIRST_NAME4, SUR_NAME4, PHONE4, EXT4, EMAIL4, IDIR_USER, DEFAULT, IDIR_USER, DEFAULT, MIDDLE_NAME, 'PER'),
        (PARTY_GUID1, FIRST_NAME, SUR_NAME, PHONE, EXT, EMAIL, IDIR_USER, DEFAULT, IDIR_USER, DEFAULT, MIDDLE_NAME, 'PER'),
        (PARTY_GUID2, NULL      , SUR_NAME, PHONE, EXT, EMAIL, IDIR_USER, DEFAULT, IDIR_USER, DEFAULT, MIDDLE_NAME, 'ORG');
