...
# cx_Oracle.init_oracle_client(config_dir='/opt/app-root/oracle_bin/instantclient/network/admin')
cx_Oracle.init_oracle_client(lib_dir='/opt/app-root/oracle_bin/instantclient', config_dir='/opt/app-root/oracle_bin/instantclient/network/admin')
